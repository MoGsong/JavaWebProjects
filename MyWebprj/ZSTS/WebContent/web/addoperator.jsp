                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal m-t" id="signupForm"
                                 id="frm" action="http://192.168.1.196:8080/ZSTS/operator?op=add" method="post">    
	                             <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="pic" name="pic" class="form-control" type="pic">
                                        </div>
                                    </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="role" name="role" class="form-control" type="role">
                                        </div>
                                    </div>
