...
<link href="http://localhost:8080/ZSTS/web/css/bootstrap.min.css?v=3.4.0" rel="stylesheet">
<link href="http://localhost:8080/ZSTS/web/css/custom.css" rel="stylesheet">
<link href="http://localhost:8080/ZSTS/web/css/style.css?v=2.2.0" rel="stylesheet">
...
<body>
	...
	<!-- Mainly scripts -->
	<script src="http://localhost:8080/ZSTS/web/js/jquery-2.1.1.min.js"></script>



	<!-- iCheck -->
	<script src="http://localhost:8080/ZSTS/web/js/plugins/iCheck/icheck.min.js"></script>
	<script>
