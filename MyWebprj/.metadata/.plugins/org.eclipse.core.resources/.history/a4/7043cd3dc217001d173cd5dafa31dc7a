...
public class uServer extends JFrame implements ActionListener{
	private static final long serialVersionUID = 1L;
	  ...
	  SQLException, IOException{ Doctor doctor = new
	  DoctorDAO().findByPrimaryKey(2); new uServer(doctor); }
	...
	// 构造器
		public uServer(Doctor doctor) throws IOException{
			...
			this.setName(name);
			this.setTitle(doctor.getName()+"会诊室");
