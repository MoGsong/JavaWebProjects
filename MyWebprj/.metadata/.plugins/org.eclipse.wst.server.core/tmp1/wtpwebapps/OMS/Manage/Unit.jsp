                        ...
                        <div class="modal-body">
                            ...
                            <div class="deadline-form">
                                <form id="updateForm" method="post" action=<%=updateUrl %>>
                                    ...
                                    <div class="col-sm-6" style="max-width: 100%">
                                        <label for="deptwo" class="form-label">负责人</label>
                                        <input  type="text" class="form-control" id="updatePrincipal" name="updatePrincipal">
                                    </div>
                                    <div class="col-sm-6" style="max-width: 100%">
                                        <label for="deptwo" class="form-label">负责人联系电话</label>
                                        <input style="width:100%"  type="text" class="form-control" id="updateTel"  name="updateTel">
                                    </div>
