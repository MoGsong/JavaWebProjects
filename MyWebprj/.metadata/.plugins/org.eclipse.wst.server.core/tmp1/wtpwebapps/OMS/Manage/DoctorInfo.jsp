                        ...
                        <div class="card teacher-card  mb-3">
                            <div class="card-body d-flex teacher-fulldeatil">
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-4 ps-sm-4 ps-4 w-100">
                                    <h6 class="mb-0 mt-2  fw-bold d-block fs-6">（姓名）</h6>
                                    
                                        <div class="row g-2 pt-2">
                                            <div class="col-xl-5">
                                                <div class="d-flex align-items-center">
                                                   
                                                    <span class="ms-2">性别： </span>
                                                </div>
                                            </div>
                                            <div class="row g-2 pt-2">
                                                <div class="col-xl-5">
                                    ...
                                    <div class="row g-2 pt-2">
                                        ...
                                        <div class="col-xl-5">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="ms-2">年龄</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <button type="" class="btn btn-primary mt-4" onclick="xxx(document.getElementById('page').value)"/>返回</button>
                                            </div>
                                    </div>
                                </div>
                            </div>
