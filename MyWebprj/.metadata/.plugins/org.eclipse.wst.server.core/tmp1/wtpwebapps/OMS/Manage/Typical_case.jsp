...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
	 ...
	 String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
 	 String url = Data.URL+"/typical_case";
 %>
...
<body>
    ...
    <div id="ihealth-layout" class="theme-tradewind">
        ...
        <div class="main px-lg-4 px-md-4">
										   ...
										   %>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="fw-bold ms-1"><%=typical_case.getTitle() %></span>
                                                </td>
                                                <td>
                                                    <img class="avatar rounded-circle" 
                                                     src="<%=Data.URL%>/Patient/img/<%=typical_case.getPic()%>" 
                                                        alt="">
                                                </td>
                                                <td>
                                                	<%=typical_case.getContent() %>   
                                                </td>
                                                
                                                <td>
                                                    <%=typical_case.getDate() %>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <button type="button" class="btn btn-outline-secondary"
                                                            ...
                                                            onclick="edit(this,<%=typical_case.getId() %>)" >
                                                            <i class="icofont-edit text-success"></i></button>
                                                        
                                                        <!-- 删除 -->    
                                                        
                                                        <%String url2 = Data.URL + "/typical_case?id=" + typical_case.getId(); %> 
			...
			<%
			String url1 =Data.URL+ "/typical_case?OP=add";
			%>
            <!-- 添加科普文章 -->
            ...
            <!-- 编辑科普文章-->
            <%
			String url3 =Data.URL+ "/typical_case?OP=doupdate";
			%>
    ...
    function edit(obj,id){
        ...
        var pic = $td.eq(2).text().replace(/\s*/g,"");
        var content = $td.eq(3).text().replace(/\s*/g,"");
        var date = $td.eq(4).text().replace(/\s*/g,"");
        //alert(tel);
