...
<%@page import="com.gxnu.action.manage.RegistrationPic"%>
...
<%
		...
		session.setAttribute("REGISTRATIONPIC", doctorId);		
		String fileName = RegistrationPic.getLineChart(session);       
%>
<body>
                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">预约人数统计图</h3>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <img src="<%=basePath %>DisplayChart?filename=<%=fileName%>" width="700" height="500" border="0"></img>
                            </div>
                        </div>
