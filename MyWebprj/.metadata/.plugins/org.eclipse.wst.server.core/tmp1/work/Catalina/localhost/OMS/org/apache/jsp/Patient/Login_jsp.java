 ...
 * Generated at: 2022-08-11 02:37:33 UTC
...
public final class Login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<li class=\"active\">用户登录</li>\r\n");
      out.write("\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h2>在线医疗系统登录</h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!--如果是医生登录则不需要下面这行内容-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>没有账号？ <a href=\"Register.jsp\">在此注册</a></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- Form -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<form class=\"form\" method=\"post\" action=\"");
      out.print(Data.URL);
      out.write("/patientlogin?OP=login\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"username\" placeholder=\"输入账号\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"password\" name=\"password\" placeholder=\"输入密码\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkcode\" name=\"checkcode\" placeholder=\"输入验证码\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<img src=\"");
      out.print(Data.URL );
      out.write("/checkcode\" style=\"width: 80px;height: 40px\" onclick=\"this.src = this.src +'?'\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div></br>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn\" type=\"submit\">登录</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"ForgetPassword.jsp\" class=\"lost-pass\">忘记密码 ?</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div></br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!--/ End Form -->\r\n");
