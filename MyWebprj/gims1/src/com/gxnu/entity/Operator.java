...
public class Operator implements Serializable{
	...
	public Operator(int id, String username, String password, String tel, String pic, Role role) {
		super();
		this.id = id;
		this.username = username;
		this.password = password;
	...
	public Operator(String username, String password, String tel, String pic,Role role) {
		super();
		this.username = username;
		this.password = password;
		this.tel = tel;
