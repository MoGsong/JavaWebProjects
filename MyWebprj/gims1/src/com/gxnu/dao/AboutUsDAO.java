...
public class AboutUsDAO  extends C3P0BaseDAO{
	...
	public void add(AboutUs aboutUs) throws ClassNotFoundException, SQLException {
		...
		PreparedStatement pstmt = 
				conn.prepareStatement("insert into about_us (name,address,tel,synopsis) values(?,?,?,?)");
	...
	public void merge(AboutUs aboutUs) throws ClassNotFoundException, SQLException {
		...
		Connection conn = super.getConnection();
		PreparedStatement pstmt = 
				conn.prepareStatement("update about_us set name=?,address=?,tel=?,synopsis=? where id=?");
	...
	public void delete(AboutUs aboutUs) throws ClassNotFoundException, SQLException {
		...
		Connection conn = super.getConnection();
		PreparedStatement pstmt = conn.prepareStatement("delete from about_us where id=?");
	...
	public AboutUs read(int id) throws ClassNotFoundException, SQLException {
		...
		PreparedStatement pstmt = conn.prepareStatement("select * from about_us where id = ?");
		pstmt.setInt(1, id);
 ...
 */
	public AboutUs[] read_all() throws ClassNotFoundException, SQLException {
		...
		PreparedStatement pstmt = conn.prepareStatement("select * from about_us");
	...
	public List<AboutUs> read_all(int currentPage, int pageSize) throws ClassNotFoundException, SQLException {
		...
		PreparedStatement pstmt = conn.prepareStatement("select * from about_us limit ?,?");
	...
	public int count() throws ClassNotFoundException, SQLException {
		...
		PreparedStatement pstmt = conn.prepareStatement("select count(*) from about_us");
