                        ...
                        <div class="faq-item">
                            ...
                            <%
                            	...
                            	for(Recipe recipe: recipes){
                            		Record record = recordService.find(recipe.getPatient().getId());
                            %>
                                <li class="wow fadeInUp" data-wow-delay=".2s">
                                    <a>主治医师：<%=recipe.getDoctor() %>&nbsp&nbsp 就诊时间：<%=recipe.getTime()  %></a>
                                    <p>
	                                    <span class="cassinfo_shwo" >症状：</span><br>
										<%=record.getDisease() %><br>
										<span class="cassinfo_shwo">诊断结果：</span><br> 
										<%=record.getResult() %>
										<%=recipe.getProof() %>
                                    </p>
                                </li>
