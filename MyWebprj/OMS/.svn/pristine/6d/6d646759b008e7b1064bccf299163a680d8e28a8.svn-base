   ...
   <div class="main px-lg-4 px-md-4">
        ...
        <div class="body d-flex py-3">
            <div class="container-xxl">
                ...
                <div class="row mb-3">
                    <div class="card">
                   <form id="frm" action="<%=Data.URL%>/Doctor/addRecord.jsp" > 
                        <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><%=registration.getNumber() %></td>
                                                             ...
                                                             <button type="button" class="btn btn-primary lift"
                                                              onclick="toChat()" >进入聊天室</button>
                                                              <script type="text/javascript">
	                                                              function toChat(){
	                                                      				window.location.href="<%=Data.URL%>/login?registrationId=<%=registration.getId() %>&doctorId=<%=registration.getDoctor().getId() %>"
	                                                      		  }
                                                              </script>
                                                             </div>
                                                                                                      
                                                             <div class="btn-group" role="group" aria-label="Basic outlined example">                   
                                                             <button type="button" class="btn btn-primary lift" onclick="turn()" >填写病例</button>
                                                             </div>
                                                             
                                                             <input type="hidden" name="doctorId" value="<%=registration.getDoctor().getId()%>"/>
                                                              <input type="hidden" name="patientId" value="<%=registration.getPatient().getId()%>"/>
