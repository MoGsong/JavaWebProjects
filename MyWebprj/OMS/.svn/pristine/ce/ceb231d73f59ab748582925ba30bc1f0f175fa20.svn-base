...
<html class="no-js" lang="zxx">
    ...
    <body>
		...
		<div class="color-plate">
			...
			<h4>中间部分</h4>
			<p>>以下是Mediplus模板上提供的一些很棒的颜色</p>.</p>
		...
		<div class="breadcrumbs overlay">
			<div class="container">
				<div class="bread-inner">
					<div class="row">
						<div class="col-12">
							<h2 style="font-family:华文行楷,serif;">修改密码</h2>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row"> 
						<div class="col-lg-6">
							<div class="login-form">
								<!-- Form -->
								<form class="form" method="post" action="<%=Data.URL%>/updatepwd?OP=msg&CHECKCODE=<%=checkcode%>&id=<%=patient.getId()%>">
										<div class="col-lg-12">
	                                     ...
	                                     <div class="col-lg-12">
                                            <div class="form-group">
		                                         <div class="form-group" style="width: 400px;margin:0px auto;">
			                                                                                                                        确认密码：<input type="password" name="newpassword"  required="">
		                                         </div>
		                                    </div>   
	                                     </div>
	                                     <div class="col-lg-12">
										...
										<div class="col-12">
											<div class="form-group login-btn" style="width: 400px;margin:0px auto;">
