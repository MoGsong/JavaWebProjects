...
<%@page import="com.gxnu.entity.Record"%>
<%@page import="java.util.List"%>
<%@page import="com.gxnu.service.IRecordService"%>
<%@page import="com.gxnu.service.imp.RecordService"%>
...
<%
	...
	List<Record> records=recordService.find();
%>
<body>
<form id="frm" action="<%=Data.URL %>/record?OP=delete" method="post">
                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">病例信息管理</h3>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                <div class="row mb-3">
                                ...
                                <tbody>
                                    ...
                                    <%
                                     ...
                                     %>   
                                                        <tr>
                                                            <th><%=record.getId() %></th>
                                                            <td><%=record.getPatient().getName() %></td>
                                                            <td><%=record.getDoctor().getName() %></td>
                                                            <td><%=record.getDisease() %></td>
                                                            <td><%=record.getTime() %></td>
                                                            <td><%=record.getResult() %></td>
                                                             <td>
                                                             <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                             	<button type="submit" class="btn btn-outline-secondary" onclick=tj()><i class="icofont-ui-delete text-danger"></i></button>
