                    ...
                    <div class="col-sm-12">
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">医生基本信息</h6>
                            </div>
                            <div class="card-body">
                                <form>
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <label for="admitdate" class="form-label">年龄</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="emailaddress" class="form-label">密码</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="lastname" class="form-label">职位</label>
                                            <input type="text" class="form-control" id="lastname" required="">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="lastname" class="form-label">电话</label>
                                            <input type="text" class="form-control" id="lastname" required="">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="lastname" class="form-label">邮件</label>
                                            <input type="text" class="form-control" id="lastname" required="">
                                        </div>
                                        <div class="col-md-6">
