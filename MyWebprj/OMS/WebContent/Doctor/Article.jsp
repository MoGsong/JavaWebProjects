...
<body>
	...
	<div id="ihealth-layout" class="theme-tradewind">
		...
		<div class="main px-lg-4 px-md-4">
									...
									<table id="myProjectTable"
										...
										<tbody>
											...
											<tr>
												...
												<td><span class="fw-bold ms-1"><%=article.getTitle()%></span>
												</td>
												<td><img class="avatar rounded-circle"
													src="<%=Data.URL%>/Doctor/static/picture/<%=article.getPic()%>">
			...
			<%
				String url1 = Data.URL + "/article2?OP=add";
			%>
			<!-- 添加科普文章 -->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="deadline-form">
								<form id="addfrm" action="<%=url1%>" method="post"
									...
									<div class="col-sm-6">
										<label for="deptwo" class="form-label">作者</label> <input
											type="text" class="form-control" id="author" name="author">
									</div>
									<div class="col-sm-6">
										<label for="depone" class="form-label">图片</label> <input
											type="file" class="form-control" id="pic" name="pic">
						...
						<div class="modal-footer">
							...
							<input type="button" class="btn btn-primary" onclick="tj()"
								value="添加" />
						</div>
					</div>
				</div>
			...
			<!-- 编辑科普文章-->
			<%
				String url3 = Data.URL + "/article2?OP=doupdate";
			%>
				...
				<div
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="deadline-form">
								<form id="updatefrm" action="<%=url3%>" method="post"
									enctype="multipart/form-data">
									<div class="mb-3">
									...
									<div class="col-sm-6">
										<label for="depone" class="form-label">作者</label> <input
											type="text" class="form-control" id="updateauthor"
											name="updateauthor">
									</div>
									<div class="col-sm-6">
										<label for="depone" class="form-label">图片</label> <input
											type="file" class="form-control" id="updatepic"
											name="updatepic">
									</div>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary"
								data-bs-dismiss="modal">取消</button>
							<input type="button" class="btn btn-primary" onclick="updatetj()"
								value="保存" />
