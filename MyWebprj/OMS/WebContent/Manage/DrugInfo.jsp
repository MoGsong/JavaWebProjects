...
<body>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0"
                                        ...
                                        <tbody>
                                        <!-- 此处调用业务层方法,返回一个DrugInfo对象集合，循环遍历 -->
                                        <% IDrugInfoService iis = new DrugInfoService();
                                           List<DrugInfo> drugInfos = iis.findAll();
                                           int i = 1;
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- 药品名称 -->
                                                    <span class="fw-bold ms-1"><%=drugInfo.getName()%></span>
                                                </td>
                                                <td>
                                                    <!-- 成分 -->
                                                   <span><%=drugInfo.getElement() %></span>
                                                </td>
                                                <td>
                                                    <!-- 功效 -->
                                                    <span><%=drugInfo.getEffect()%></span>
                                                </td>
                                                <td>
                                                	<!-- 注意事项-->
                                                    <span><%=drugInfo.getNotice() %></span>
                                                </td>
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <button type="button" class="btn btn-outline-secondary"
                                                            data-bs-toggle="modal" data-bs-target="#depedit" onclick="edit(this,<%=drugInfo.getId()%>)"><i
                                                                class="icofont-edit text-success"></i></button>
                                                                
                                                        <button type="button"
                                                            onclick="window.location.href='<%=Data.URL%>/drugInfo?OP=delete&ID=<%=drugInfo.getId()%>'"><i
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="deadline-form">
                                <form action="<%=Data.URL%>/drugInfo?OP=add" method="post">
                                    <div class="col-sm-6">
                                        <label for="depone" class="form-label">药品名称</label>
                                        <input type="text" class="form-control" id="depone" name="NAME">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="deptwo" class="form-label">成分</label>
                                        <input type="text" class="form-control" id="deptwo" name="ELEMENT">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="depthree" class="form-label">功效</label>
                                        <input type="text" class="form-control" id="depthree" name="EFFECT">
                                    </div>
                                    <div class="col-sm-6">
                                    <label for="depfour" class="form-label">注意事项</label>
                                    <input type="text" class="form-control" id="depfour" name="NOTICE">
                                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="deadline-form">
                                <form action="<%=Data.URL%>/drugInfo?OP=update" method="post">
                                    <div class="col-sm-6">
                                        <label for="depone" class="form-label">药品名称</label>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="deptwo" class="form-label">成分</label>
                                        <input type="text" class="form-control" id="updatetwo" name="ELEMENT">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="depthree" class="form-label">功效</label>
                                        <input type="text" class="form-control" id="updatethree" name="EFFECT">
                                    </div>
                                    <div class="col-sm-6">
                                    <label for="depfour" class="form-label">注意事项</label>
                                    <input type="text" class="form-control" id="updatefour" name="NOTICE">
    ...
    <script>
	    function edit(obj,id){
	        ...
	        var element = $td.eq(2).text().replace(/\s*/g,"");
	        var effect = $td.eq(3).text().replace(/\s*/g,"");
	        var notice = $td.eq(4).text().replace(/\s*/g,"");
	        //alert(tel);
	      ...
	      $("#updatetwo").val(element);
	        $("#updatethree").val(effect);
	        $("#updatefour").val(notice);
