				...
				<div class="single-slider" style="background-image:url('img/slider2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>以最好的服务 <span>帮助你远离病痛</span></h1>
									<div class="button">
										<a href="#" class="btn">前往预约</a>
								...
								<div class="inner">
									...
									<div class="single-content">
										...
										<ul class="time-sidual">
											<li class="day">上午 <span>9：00-12：00</span></li>
											<li class="day">下午 <span>15：00-17：00</span></li>
											<li class="day">晚上 <span>暂时不上班</span></li>
										</ul>
										<a href="#">LEARN MORE<i class="fa fa-long-arrow-right"></i></a>
									</div>
								</div>
