...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     ...
     Patient patient=patientDAO.find(8);
	  ...
	  <%
	   ...
	   // 获取是一个servlet 转发过来的数据   
	      //Object obj=request.getAttribute("USER"); //request.getAttribute（）请求转发携带过来的数据
	    //  Patient patient=new Patient(); //初始的空对象
	     // if(obj!=null){
	     // patient=(Patient)obj;   // 进行强转  把obj转成我们需要的Main	    mail=我们需要获取的信息
	      //System.out.println(patient);  //获取到信息
	   // }  %>
...
function tjjs(){
	//获取html页面中的表单
	window.document.getElementById("jsj").submit();
}
</script>
</head>
<body>
					...
					<div class="row"> 
						<div class="col-lg-6">
							<div class="register-form">
								...
								<!-- Form -->
								<form class="form" id="jsj" action="<%=Data.URL%>/patient?OP=roupdate" method="post" enctype="multipart/form-data">
								
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<input type="text" name="name" placeholder="账号" value="<%=patient.getUsername()%>">
											</div>
										</div>
										...
										<div class="col-12">
											<div class="form-group login-btn">											   
											     ...
											     <input type="button" onclick="tjjs()" value="确定注销"/>
											</div>
