					...
					<div class="row"> 
						<div class="col-lg-6">
							<div class="register-form">
								<h2>个人信息修改</h2>
								<p>如果想修改密码，<a href="login.html">请点击这里</a></p>
								<!-- Form -->
								<form class="form" method="post" action="#">
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="form-group">
												<input type="text" name="name" placeholder="年龄" required="">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<input type="email" name="email" placeholder="联系电话" required="">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
										...
										<div class="col-lg-6">
											<div class="form-group">
												<input type="password" name="password" placeholder="修改头像" required="">
											</div>
										</div>
										<div class="col-12">
											<div class="form-group login-btn">
												<button class="btn" type="submit">确定修改</button>
											</div>
