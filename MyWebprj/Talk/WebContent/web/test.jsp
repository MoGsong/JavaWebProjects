...
<%
	//使用java执行js语句，在点击发送的时候，直接将发送的信息在jsp中显示，不必通过提交到servlet响应再显示
	ScriptEngineManager scriptManager = new ScriptEngineManager();

	ScriptEngine scriptEngine = scriptManager.getEngineByName("js");
	String content = (String)scriptEngine.eval("document.querySelector('#textarea').value;");
%>
<body>
<div class="container">
        <div class="content">
...
function send(){
    ...
    item.innerHTML = `<div class="bubble bubble-left"><%=content %></div><div class="avatar"><img src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3313909130,2406410525&fm=15&gp=0.jpg" /></div>`;
