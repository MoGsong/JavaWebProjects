        ...
        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="input-area">
                        ...
                        $.ajax({
                            url: <%=Data.URL %>+"dialogue", //提交的路径
                            type: "post",       //提交方式
                            data: {
                            	"id="+1+"&amp;"+"info="+document.querySelector('#textarea').value;
                            },
...
<%-- 	<script type="text/javascript">
	 $("#send-btn").click(function(){
  	   $.ajax({
             url: /*前缀Data.URL + */  <%=Data.URL%>+"/web/static/sendInfo.js" //直接执行js发送消息
                 //"dialogue?op=wrap", //提交的路径,将data数据包装
             type: "post",       //提交方式
             data: {
             	id=1<%=request.getParameter("id")%>&amp;info=${text};
             },
             dataType: "JSON",       //规定请求成功后返回的数据
             success: function (data) {
                 //包装成功后，将信息显示再页面
                 //$.getScript("sendInfo.js");
                 //重新请求，在servlet修改改该请求，使其在接受方响应显示收到的信息
                 window.document.href= <%=Data.URL %> + "dialogue?id="+data["id"]+"&info="+ ${text}+"&op=send";/* data = +"&info="+ ${text} */
    ...
    <script type="text/javascript">
	    function send() {
	        ...
	        item.innerHTML = `<div class="bubble bubble-left"><%= %></div><div class="avatar"><img src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3313909130,2406410525&fm=15&gp=0.jpg" /></div>`;
