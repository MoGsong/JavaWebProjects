            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="row">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <%String URL = Data.URL +  "/xxx?OP=add";%>
                                <form class="form-horizontal m-t" id="signupForm" id="js" action="<%=URL%>" method="post">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">类型</label>
                                        <div class="col-sm-8">
                                            <input id="firstname" name="types" class="form-control" type="text" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password" name="time" class="form-control" type="text" 
                                           class="Wdate" onFocus="WdatePicker({lang:'zh-cn',startDate:'%y-%M-%d %H:%m:%s',dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                                        </div>
                                    </div>
